      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 cursor-pointer">
          {visibleProjects.map((project, index) => (
            <div
              key={index}
              className="bg-white dark:bg-neutral-900 rounded-2xl border border-gray-200 dark:border-neutral-800 p-6 flex flex-col justify-between hover:shadow-md transition"
            >
              <div>
        ...
        <div className="flex justify-center mt-12">
          {!showAll && projects.length > 3 && (
            <button
              ...
              className="px-6 py-3 rounded-lg border border-gray-300 dark:border-neutral-700 text-gray-800 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-neutral-800 transition"
            >
